...
$TCA["tx_kesmallads_smallads"] = Array (
	...
	"interface" => Array (
		"showRecordFieldList" => "sys_language_uid,l18n_parent,l18n_diffsource,hidden,starttime,endtime,fe_group,cat,cat2,cat3,user,content,image,email,phone,displayemail,title,reviewed",
		'maxDBListItems' => 25,
	...
	"columns" => Array (
		...
		"cat2" => Array (		
			"exclude" => 0,		
			"label" => "LLL:EXT:ke_smallads/locallang_db.php:tx_kesmallads_smallads.cat2",		
			"config" => Array (
				"type" => "input",	
				"size" => "20",	
				"max" => "50",	
		...
		"cat3" => Array (		
			"exclude" => 0,		
			"label" => "LLL:EXT:ke_smallads/locallang_db.php:tx_kesmallads_smallads.cat3",		
			"config" => Array (
				"type" => "input",	
				"size" => "20",	
				"max" => "50",	
